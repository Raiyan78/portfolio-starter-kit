...
//           >
//             <p className="text-neutral-800 dark:text-neutral-400 tabular-nums">

//               {formatDate(post.metadata.publishedAt, false)}
//             </p>

//             <div className="text-neutral-950 dark:text-neutral-100 tracking-tight">
      ...
      {allBlogs
        ...
        .map((post) => (
          <Link
            ...
            className="grid grid-cols-[100px_1fr] gap-x-4"
          >
            <p className="text-black dark:text-neutral-400 tabular-nums">
              {formatDate(post.metadata.publishedAt, false)}
            </p>

            <div className="text-black dark:text-neutral-100 tracking-tight">
              <p className="font-medium">{post.metadata.title}</p>

              {post.metadata.authors && (
                <p className="text-sm text-black dark:text-neutral-300 mt-1">
                  {post.metadata.authors
                    .split(/\s*,\s*/)
                    .map((author, index, array) => {
                      const isMe = author.trim() === 'Raiyan Rahman'
...
//           >
//             <div className="w-full flex flex-col md:flex-row space-x-0 md:space-x-2">
//               <p className="text-neutral-800 dark:text-neutral-400 w-[100px] tabular-nums">

//                 {formatDate(post.metadata.publishedAt, false)}
//               </p>
//               <p className="text-neutral-950 dark:text-neutral-100 tracking-tight">
    ...
    <div>
      {allBlogs
        ...
        .map((post) => (
          ...
          >
            <div className="w-full flex flex-col md:flex-row space-x-0 md:space-x-2">
              <p className="text-black dark:text-neutral-400 w-[100px] tabular-nums">
                {formatDate(post.metadata.publishedAt, false)}
              </p>
              <p className="text-black dark:text-neutral-100 tracking-tight">
                {post.metadata.title}
